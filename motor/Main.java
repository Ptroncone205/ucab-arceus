...
import com.motor.terrains.HeightMapTerrain;
...
public class Main extends ApplicationAdapter
{
	...
	private float camPitch = Settings.CAMERA_DEFAULT_PITCH;
	...
	public void create() {
		...
		player  = new Player(playerScene, new Vector3(0,30,0));
		physicsWorld.getDynamicsWorld().addRigidBody(player.getRigidBody());
	...
	private void buildTerrain() {
		...
		terrain = new HeightMapTerrain("textures/heightmap.png", 15f, 5f);
		physicsWorld.getDynamicsWorld().addRigidBody(terrain.getRigidBody());
	...
	private void processInput (float deltaTime) {
        ...
        camRight.y = 0;
        camRight.nor();
		if (Gdx.input.isKeyJustPressed(Input.Keys.SPACE)){ //&& player.getRigidBody().checkCollideWithOverride(terrain.getRigidBody())){//checkCollideWith(terrain.getRigidBody())) {
