...
public class PlayMenu extends MenuOverlay {
    public PlayMenu(Skin skin, MenuUI menu){
        ...
        botT.add(btnSave).width(150).height(50).padBottom(15).row();
        botT.add(btnHelp).width(150).height(50).padBottom(15).row();
        botT.add(btnBack).width(150).height(50).padBottom(15).row();
