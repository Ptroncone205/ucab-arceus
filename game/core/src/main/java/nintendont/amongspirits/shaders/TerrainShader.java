...
import nintendont.amongspirits.terrains.TerrainMaterial;
...
public class TerrainShader extends BaseShader {
    ...
    private static TerrainMaterial getTerrainMaterial(Renderable renderable) {
        ...
        if (attr == null) {
            // Log all attributes currently in the material to debug
            Gdx.app.error("TerrainShader", "Material is missing TerrainMaterialAttribute!");
            for (com.badlogic.gdx.graphics.g3d.Attribute a : renderable.material) {
                Gdx.app.error("TerrainShader", "Existing attribute: " + a.toString());
            }
            return null;
        }
