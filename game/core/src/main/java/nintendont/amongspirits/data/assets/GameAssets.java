package nintendont.amongspirits.data.assets;
...
public class GameAssets {
    public static final AssetDescriptor<Texture> FIGHT_BACKGROUND = new AssetDescriptor<>("sprites/backgrounds/fightbg.jpg", Texture.class);
    ...
    public static final AssetDescriptor<SceneAsset> BUNNY_SCENE = new AssetDescriptor<>("models/bunny/scene.gltf", SceneAsset.class);
